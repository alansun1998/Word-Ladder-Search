...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	@Test(timeout = 30000)
	public void TestSameWordDFS() {
		ArrayList<String> res = Main.getWordLadderDFS("aldol", "aldol");
		if (res != null) {
			assertEquals(2, res.size());
			assertEquals("[ALDOL, ALDOL]",res.toString());
		}
	}
	@Test(timeout = 30000)
	public void TestSameWordBFS() {
		ArrayList<String> res = Main.getWordLadderBFS("aldol", "aldol");
		if (res != null) {
			assertEquals(2, res.size());
			assertEquals("[ALDOL, ALDOL]",res.toString());
		}
	...
	@Test(timeout = 30000)
	public void StartNotInDicBFS() {
		ArrayList<String> res = Main.getWordLadderBFS("aaaaa", "aldol");
		if (res != null) {
			assertEquals(2, res.size());
			assertEquals("[AAAAA, ALDOL]",res.toString());
		}
	}

	@Test(timeout = 30000)
	public void StartNotInDicDFS() {
		ArrayList<String> res = Main.getWordLadderDFS("aaaaa", "aldol");
		if (res != null) {
			assertEquals(2, res.size());
			assertEquals("[AAAAA, ALDOL]",res.toString());
		}
	...
	@Test(timeout = 30000)
	public void EndNotInDicDFS() {
		ArrayList<String> res = Main.getWordLadderDFS("stone", "aaaaa");
		if (res != null) {
			assertEquals(2, res.size());
			assertEquals("[STONE, AAAAA]",res.toString());
		}
	}

	@Test(timeout = 30000)
	public void EndNotInDicBFS() {
		ArrayList<String> res = Main.getWordLadderBFS("stone", "aaaaa");
		if (res != null) {
			assertEquals(2, res.size());
			assertEquals("[STONE, AAAAA]",res.toString());
		}
	...
	@Test(timeout = 30000)
	public void worksBFS() {
		ArrayList<String> res = Main.getWordLadderBFS("books", "stone");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	@Test(timeout = 30000)
	public void worksDFS() {
		ArrayList<String> res = Main.getWordLadderDFS("books", "stone");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
